# Historical five-source enrichment pilot

Historical report: ACS/TIGER are now deferred and their local artifacts have been removed.
See the [current pilot](../../pilot_validation.md) and [future scope](../../../../docs/CENSUS_TRACTS.md).
